...
const server_port = 'http://localhost:8000/api/chat/'; // Ubah ini sesuai dengan port server Anda
...
const Chatbot: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const storedUserId = Cookies.get('userId'); // Dapatkan ID pengguna dari cookie
        if (storedUserId) {
